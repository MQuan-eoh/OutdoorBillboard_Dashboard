...
class EraAuthService {
    ...
    async login(credentials) {
        try {
            console.log("EraAuthService: Attempting login for username:", credentials.username);
            ...
            console.log("EraAuthService: Login response:", response.status, responseData);
...
exports.default = EraAuthService;
